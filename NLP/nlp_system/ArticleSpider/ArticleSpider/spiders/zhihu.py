...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        browser.find_element_by_css_selector(
            "#root > div > main > div > div > div > div.SignContainer-content > div > form > div.SignFlow-tabs > div:nth-child(2)").click()
        browser.find_element_by_css_selector("#root > div > main > div > div > div > div.SignContainer-content > div > form > div.SignFlow-account > div > label > input").send_keys(
            "jsjhfx@163.com")
        browser.find_element_by_css_selector("#root > div > main > div > div > div > div.SignContainer-content > div > form > div.SignFlow-password > div > label > input").send_keys(
            "fx20001012")
        import time
        time.sleep(5)
        browser.find_element_by_css_selector(
            "#root > div > main > div > div > div > div.SignContainer-content > div > form > button").click()
